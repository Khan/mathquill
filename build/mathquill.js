...
function closest(el, s) {
  var _a, _b, _c;
  if (
    typeof ((_a = el) === null || _a === void 0 ? void 0 : _a.closest) ===
    'function'
  ) {
    return el.closest(s);
  }
...
var NodeBase = /** @class */ (function () {
  ...
  NodeBase.prototype.shouldIgnoreSubstitutionInSimpleSubscript = function (
    options
  ) {
  ...
  NodeBase.prototype.registerInnerField = function (
    _innerFields,
    _mathField
  ) {};
...
var Fragment = /** @class */ (function () {
  function Fragment(withDir, oppDir, dir) {
    ...
    var ends = ((_d = {}), (_d[dir] = withDir), (_d[-dir] = oppDir), _d);
    this.setEnds(ends);
    var maybeRightEnd = 0;
  ...
  Fragment.prototype.adopt = function (parent, leftward, rightward) {
    ...
    var ends =
      ((_c = {}), (_c[L] = parent.getEnd(L)), (_c[R] = parent.getEnd(R)), _c);
    if (leftward) {
...
var Cursor = /** @class */ (function (_super) {
  ...
  Cursor.prototype.getBoundingClientRectWithoutMargin = function () {
    ...
    var _c = getBoundingClientRect(frag.oneElement()),
      left = _c.left,
      right = _c.right;
...
var ControllerBase = /** @class */ (function () {
  ...
  ControllerBase.prototype.setAriaPostLabel = function (
    ariaPostLabel,
    timeout
  ) {
    var _this_1 = this;
      ...
      if (ariaPostLabel !== this.ariaPostLabel && typeof timeout === 'number') {
        ...
        this._ariaAlertTimeout = setTimeout(function () {
          if (_this_1.containerHasFocus()) {
            ...
            _this_1.aria.alert(
              _this_1.root.mathspeak().trim() + ' ' + ariaPostLabel.trim()
            );
          } else {
...
function getInterface(v) {
  ...
  var optionProcessors = __assign(__assign({}, baseOptionProcessors), {
  ...
  var EditableField = /** @class */ (function (_super) {
    ...
    EditableField.prototype.setAriaPostLabel = function (
      ariaPostLabel,
      timeout
    ) {
  ...
  var MQ = function (el) {
    ...
    for (
      var _i = 0, childArray_1 = childArray;
      _i < childArray_1.length;
      _i++
    ) {
...
var Controller_focusBlur = /** @class */ (function (_super) {
  ...
  function Controller_focusBlur() {
    ...
    _this_1.handleTextareaFocusEditable = function () {
      ...
      if (!cursor.parent) cursor.insAtRightEnd(_this_1.root);
      if (cursor.selection) {
  ...
  Controller_focusBlur.prototype.disableGroupingForSeconds = function (
    seconds
  ) {
    var _this_1 = this;
...
var Controller_keystroke = /** @class */ (function (_super) {
  ...
  Controller_keystroke.prototype.moveUpDown = function (dir) {
    ...
    if (cursorR_dirInto) cursor.insAtLeftEnd(cursorR_dirInto);
      ...
      cursor.parent.bubble(function (ancestor) {
        ...
        if (prop) {
          if (typeof prop === 'function') prop = prop.call(ancestor, cursor); // TODO - figure out if we need to assign to prop
          if (prop instanceof MQNode) cursor.jumpUpDown(ancestor, prop);
          if (prop !== true) return false; // TODO - figure out how this can return true
        }
        return undefined;
      });
    }
  ...
  Controller_keystroke.prototype.withIncrementalSelection = function (cb) {
    ...
    try {
      ...
      try {
        cb(function (dir) {
          return _this_1.selectDirIncremental(dir);
        });
      } finally {
...
var Controller_latex = /** @class */ (function (_super) {
  ...
  Controller_latex.prototype.classifyLatexForEfficientUpdate = function (
    latex
  ) {
  ...
  Controller_latex.prototype.updateLatexMathEfficiently = function (
    latex,
    oldLatex
  ) {
    var _c, _d, _e, _f;
    ...
    if (oldMinusSign && !newMinusSign) {
      ...
      if (root.getEnd(L) === oldMinusNode) {
        root.setEnds(
          ((_c = {}), (_c[L] = oldCharNodes[0]), (_c[R] = root.getEnd(R)), _c)
        );
      }
    ...
    if (!oldMinusSign && newMinusSign) {
      ...
      if (root.getEnd(L) === oldCharNodes[0]) {
        root.setEnds(
          ((_d = {}), (_d[L] = newMinusNode), (_d[R] = root.getEnd(R)), _d)
        );
      }
    ...
    if (oldDigits.length > newDigits.length) {
      ...
      root.setEnds(
        ((_e = {}), (_e[L] = root.getEnd(L)), (_e[R] = charNode), _e)
      );
      charNode[R] = 0;
    ...
    if (newDigits.length > oldDigits.length) {
      ...
      for (i = commonLength; i < newDigits.length; i++) {
        ...
        newNodeL[R] = newNode;
        root.setEnds(
          ((_f = {}), (_f[L] = root.getEnd(L)), (_f[R] = newNode), _f)
        );
      }
  ...
  Controller_scrollHoriz.prototype.scrollHoriz = function () {
    ...
    if (cursor.domFrag().isEmpty() && !seln) {
      ...
      animate(
        ...
        function (progress, scheduleNext, cancel) {
          if (progress >= 1) {
...
var MathCommand = /** @class */ (function (_super) {
  ...
  MathCommand.prototype.setCtrlSeqHtmlAndText = function (
    ctrlSeq,
    domView,
    textTemplate
  ) {
...
var MQSymbol = /** @class */ (function (_super) {
  ...
  MQSymbol.prototype.setCtrlSeqHtmlTextAndMathspeak = function (
    ctrlSeq,
    html,
    text,
    mathspeak
    ...
    _super.prototype.setCtrlSeqHtmlAndText.call(this, ctrlSeq, html, [
      text || '',
    ]);
  };
...
var MathBlock = /** @class */ (function (_super) {
  ...
  MathBlock.prototype.latexRecursive = function (ctx) {
    this.checkCursorContextOpen(ctx);
    this.eachChild(function (child) {
      return child.latexRecursive(ctx);
    });
    this.checkCursorContextClose(ctx);
  };
  ...
  MathBlock.prototype.mathspeak = function () {
    ...
    return (
      this.foldChildren([], function (speechArray, cmd) {
        if (cmd.isPartOfOperator) {
          ...
          if (
            isNaN(cmdText) && // TODO - revisit this to improve the isNumber() check
            cmdText !== '.' &&
            (!cmd.parent ||
              !cmd.parent.parent ||
  ...
  MathBlock.prototype.writeLatex = function (cursor, latex) {
    ...
    if (block && !block.isEmpty() && block.prepareInsertionAt(cursor)) {
      block.children().adopt(cursor.parent, cursor[L], cursor[R]); // TODO - masking undefined. should be 0
  ...
  return (
    (_c = /** @class */ (function (_super) {
      ...
      MathField.prototype.__mathquillify = function (opts, interfaceVersion) {
        ...
        _super.prototype.mathquillify.call(
          this,
...
var Digit = /** @class */ (function (_super) {
  ...
  Digit.prototype.createLeftOf = function (cursor) {
    ...
    } else _super.prototype.createLeftOf.call(this, cursor);
  };
  Digit.prototype.mathspeak = function (opts) {
    if (opts && opts.createdLeftOf) {
      ...
      if (
        ...
        return (
          'Subscript ' + _super.prototype.mathspeak.call(this) + ' Baseline'
        );
      }
    }
...
LatexCmds['\u2070'] = function () {
  return new LatexFragment('^0');
};
LatexCmds['\u00b9'] = function () {
  return new LatexFragment('^1');
};
LatexCmds['\u00b2'] = function () {
  return new LatexFragment('^2');
};
LatexCmds['\u00b3'] = function () {
  return new LatexFragment('^3');
};
LatexCmds['\u2074'] = function () {
  return new LatexFragment('^4');
};
LatexCmds['\u2075'] = function () {
  return new LatexFragment('^5');
};
LatexCmds['\u2076'] = function () {
  return new LatexFragment('^6');
};
LatexCmds['\u2077'] = function () {
  return new LatexFragment('^7');
};
LatexCmds['\u2078'] = function () {
  return new LatexFragment('^8');
};
LatexCmds['\u2079'] = function () {
  return new LatexFragment('^9');
};
LatexCmds['\u00bc'] = function () {
  return new LatexFragment('\\frac14');
};
LatexCmds['\u00bd'] = function () {
  return new LatexFragment('\\frac12');
};
LatexCmds['\u00be'] = function () {
  return new LatexFragment('\\frac34');
};
...
LatexCmds['\u00b1'] =
  ...
  LatexCmds.plusminus =
    function () {
      return new PlusMinus('\\pm ', h.entityText('&plusmn;'), 'plus-or-minus');
    };
LatexCmds.mp =
  LatexCmds.mnplus =
  LatexCmds.minusplus =
    function () {
      return new PlusMinus('\\mp ', h.entityText('&#8723;'), 'minus-or-plus');
    };
CharCmds['*'] =
  LatexCmds.sdot =
  LatexCmds.cdot =
...
var Inequality = /** @class */ (function (_super) {
  ...
  function Inequality(data, strict) {
    ...
    _this_1 =
      _super.call(
        this,
        data['ctrlSeq'.concat(strictness)],
        h.entityText(data['htmlEntity'.concat(strictness)]),
        data['text'.concat(strictness)],
        data['mathspeak'.concat(strictness)]
      ) || this;
    _this_1.data = data;
  ...
  Inequality.prototype.swap = function (strict) {
    ...
    this.domFrag()
      .children()
      .replaceWith(
        domFrag(h.entityText(this.data['htmlEntity'.concat(strictness)]))
      );
...
LatexCmds['<'] = LatexCmds.lt = function () {
  return new Inequality(less, true);
};
...
LatexCmds['\u2264'] =
  ...
  LatexCmds.leq =
    function () {
      return new Inequality(less, false);
    };
LatexCmds['\u2265'] =
  LatexCmds.ge =
  LatexCmds.geq =
    function () {
      return new Inequality(greater, false);
    };
LatexCmds.infty =
  LatexCmds.infin =
  LatexCmds.infinity =
...
var SVG_SYMBOLS = {
  ...
  '{': {
    ...
    html: function () {
      return h(
        'svg',
        { preserveAspectRatio: 'none', viewBox: '10 0 210 350' },
        [
          h('path', {
...
var SupSub = /** @class */ (function (_super) {
  ...
  SupSub.prototype.moveTowards = function (dir, cursor, updown) {
    ...
    } else _super.prototype.moveTowards.call(this, dir, cursor, updown);
  };
  SupSub.prototype.deleteTowards = function (dir, cursor) {
    ...
    } else _super.prototype.deleteTowards.call(this, dir, cursor);
  };
    ...
    for (var i = 0; i < 2; i += 1)
      (function (cmd, supsub, oppositeSupsub, updown) {
        ...
        cmdSubSub.deleteOutOf = function (dir, cursor) {
          ...
          cmdOppositeSupsub[''.concat(updown, 'OutOf')] =
...
LatexCmds['\u2211'] =
  ...
  LatexCmds.summation =
    function () {
      return new SummationNotation('\\sum ', U_NARY_SUMMATION, 'sum');
    };
LatexCmds['\u220f'] =
  LatexCmds.prod =
  LatexCmds.product =
    function () {
      return new SummationNotation('\\prod ', U_NARY_PRODUCT, 'product');
    };
...
var DelimsNode = /** @class */ (function (_super) {
  ...
  DelimsNode.prototype.setDOM = function (el) {
    ...
    if (!children.isEmpty()) {
      this.delimFrags =
        ((_c = {}), (_c[L] = children.first()), (_c[R] = children.last()), _c);
    }
    return this;
  };
  return DelimsNode;
...
var Bracket = /** @class */ (function (_super) {
  ...
  function Bracket(side, open, close, ctrlSeq, end) {
    var _c;
    var _this_1 =
      _super.call(this, '\\left' + ctrlSeq, undefined, [open, close]) || this;
    _this_1.side = side;
    _this_1.sides =
      ((_c = {}),
...
function bindCharBracketPair(open, ctrlSeq, name) {
  ...
  CharCmds[open] = function () {
    return new Bracket(L, open, close, ctrlSeq, end);
  };
  CharCmds[close] = function () {
    return new Bracket(R, open, close, ctrlSeq, end);
  };
...
var MathFieldNode = /** @class */ (function (_super) {
  ...
  MathFieldNode.prototype.registerInnerField = function (
    innerFields,
    MathField
  ) {
